...
| 4 | `1088_infidelity.ipynb` | Computes state infidelity between engineered and exact evolution as a function of Trotter step count. | `slater_matrices_1088.hdf5` | `infidelity_HH.pdf` |
